...
1. Clone this project `$ git clone git@github.com:nikesh/jbot.git`.
...
extends [Bot](../../jbot/src/main/java/me/nikesh/jbot/core/facebook/Bot.java) from the core package. You can have as many
bots as you want, just make the class extend [Bot](../../jbot/src/main/java/me/nikesh/jbot/core/facebook/Bot.java) class
...
Facebook sends [Callback](../../jbot/src/main/java/me/nikesh/jbot/core/facebook/models/Callback.java) to `/webhook` 
...
Button[] buttons = new Button[]{
        new Button().setType("web_url").setUrl("http://blog.nikesh.me").setTitle("JBot Docs"),
...
```groovy
dependencies {
    compile("me.nikesh.jbot:jbot:4.1.0")
}
```

__NOTE:__ When you include jbot as a dependency please make sure to include `me.nikesh.jbot` package for auto-scan.
...
;directory=/var/www/jbot.nikesh.me/jbot/jbot-example/       ; change this
autostart=true                 
autorestart=true               
